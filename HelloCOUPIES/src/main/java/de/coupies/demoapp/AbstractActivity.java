 ...
 *
 */
public abstract class AbstractActivity extends Fragment {
    ...
    */
	...
	protected ServiceFactory getServiceFactory() {
		if(serviceFactory == null) {
			//Access the sandbox environment. User createLiveServiceFactory for live environment
	...
	protected static ServiceFactory getStaticServiceFactory(){
		return staticServiceFactory;
	}
	
	protected static CoupiesSession getStaticCoupiesSession(){
		return staticCoupiesSession;
	}
	
	protected static Coordinate getStaticCoordinate() {
		return COORDINATE;
	}
